...
const TEXT = {
  ...
  7: `This is the average over 100 years. We can see that the areas of <b style="color: rgb(${colorUDemAvg});">unmet demand</b> does not necessarily correspond with areas of <b style="color: rgb(${colorDemAvg});">demand</b>.`,
  8: `If we take a closer look at this region, we can investigate what might have contributed to this inequity.`,
  9: `If we overlay the map with land holders, we can see that exchange holders, symbolized with cows, are the ones predominantly demanding high amounts of <b style="color: rgb(${colorDemAvg});">demand</b>. However, they aren’t suffering from as high <b style="color: rgb(${colorUDemAvg});">unmet demand</b>. In fact, they seem to be doing quite well.`,
  10: `What we should expect is more of the following. Here, a patch of land held by project holders are symbolized with a paper scroll. This area contends with high levels of <b style="color: rgb(${colorUDemAvg});">unmet demand</b>; this is expected, since it has high levels of <b style="color: rgb(${colorDemAvg});">demand</b>.`,
  11: `On the other hand, settlement holders are similar to exchange holders in that they also historically have <b style="color: rgb(${colorDemAvg});">high demand</b>, but get special treatment as well.`,
  ...
  16: `This time, the rings indicate regions that are doing <b style="color: rgb(${colorDemDiffHigh});">better</b> or <b style="color: rgb(${colorDemDiffLow});">worse</b> than real-life, or historical, baselines.`,
