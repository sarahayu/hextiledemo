import{r as i}from"./index-3bff66e1.js";import"./scales-7c027d43.js";import{g as o,k as v}from"./settings-cc329b7d.js";function b({hextiles:d=!0}){const r=i.useRef(),s=i.useRef(),t=i.useRef({});i.useEffect(()=>{r.current=document.querySelector("#main-tooltip"),s.current=document.querySelector("#secondary-tooltip")},[]);const p=i.useCallback(e=>{r.current.classList.add("active"),s.current.classList.add("active"),s.current.innerHTML=`      <div><b>GEOID</b> ${e.properties.GEOID}</div>
